...
public class VueVendeur {
	...
	public void creerVendeur(Vendeur Vendeur) {
		Image Vendeur1 = new Image(getClass().getResourceAsStream("../img/Vendeur.png"));
		...
		VendeurView.setOnMouseClicked(e -> JOptionPane.showMessageDialog(null, "Hé toi ! Viens ici j'ai des choses qui pourraient t'intéresser."));
